...
models while `doc/web-model-protection-decision.md` remains no-go.
...
- Follow `doc/web-hosted-inference-contract.md` for request, response, and
...
See `doc/web-accuracy-baseline.md` for the native ONNX comparison contract.
