#ifndef EMOTION_FILE_SECURE_STORE_H_
#define EMOTION_FILE_SECURE_STORE_H_
...
class FileSecureStore {
 public:
  explicit FileSecureStore(const std::string& root_dir);

  const emotion_secure_store_adapter_t* adapter() const;
  bool is_development_fallback() const;
...
#endif  // EMOTION_FILE_SECURE_STORE_H_
